/*
 * Demo 01 â€” Portfolio Health Check
 ...
 *   C) appsettings.json â€” edit ApiKey / UserKey directly (not safe for real keys)
 */
...
//   appsettings.json â†’ user-secrets â†’ environment variables
//
// AddEToro wires up:
//   â€˘ IEToroClient / IEToroTradingClient / IEToroMarketDataClient / â€¦
//   â€˘ Auth handler  (injects x-api-key and x-user-key headers)
//   â€˘ Rate-limiter  (sliding-window, default 60 req/min)
//   â€˘ Transient-error retry handler
...
// â”€â”€ 2. Fetch PnL (real account) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€

Console.WriteLine("Fetching real portfolioâ€¦");
...
// â”€â”€ 3. Compute metrics â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
//
// Formulas derived from the eToro PnL API structure:
//   availableCash  = credit â’ (manualOrdersForOpen + mitOrders)
...
// â”€â”€ 4. Build flat position list (manual + all mirror sub-positions) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
// â”€â”€ 5. Resolve instrument symbols for top positions â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
//
...
// â”€â”€ 6. Compute weights and health status â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
// â”€â”€ 7. Print output â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    decimal equity, decimal top1, decimal top3, decimal cash)
{
    ...
    if (cash < 2)
        return ("WATCH", $"Available cash is {cash:F2}% of equity â€” low liquidity (threshold: 2%).");
    if (top3 >= 50)
