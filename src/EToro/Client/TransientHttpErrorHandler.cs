...
public sealed partial class TransientHttpErrorHandler : DelegatingHandler
{
    ...
    [LoggerMessage(
        ...
        Message = "Retrying eToro request after transient HTTP {StatusCode}. Method: {Method}; Endpoint: {Endpoint}; Attempt: {Attempt}; Delay: {Delay}.")]
    ...
    [LoggerMessage(
        EventId = 2002,
        Level = LogLevel.Information,
        Message = "Retrying eToro request after transient network failure. Method: {Method}; Endpoint: {Endpoint}; Attempt: {Attempt}; Delay: {Delay}.")]
