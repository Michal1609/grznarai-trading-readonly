...
`src/EToro/GrznarAi.Trading.ReadOnly.csproj` obsahuje lokální fallback verzi pro běžné lokální balení. Source of truth pro publikované verze je publish workflow.
