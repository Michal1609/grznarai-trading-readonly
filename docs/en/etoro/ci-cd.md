...
`src/Etoro/GrznarAi.Trading.ReadOnly.Etoro.csproj` contains a local fallback version for normal local packing. The publish workflow is the source of truth for released package versions.
