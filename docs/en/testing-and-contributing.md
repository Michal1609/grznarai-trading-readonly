...
Or create a local ignored `tests/GrznarAi.Trading.ReadOnly.Tests/appsettings.test.json` from `appsettings.test.example.json`.
...
tests/GrznarAi.Trading.ReadOnly.Tests/            Unit and integration tests
