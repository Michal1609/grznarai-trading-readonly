...
namespace GrznarAi.Trading.ReadOnly.Etoro.Tests.Services;
...
public class EToroCalculationServiceTests
{
    ...
    // â”€â”€â”€ AvailableCash â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    {
        // credit=1000, manual pending=200, mirrored pending=100 (excluded), MIT=150 â†’ 650
        var pnl = new PnlResponse(
            1000m,
            Positions: [],
            MirrorPortfolios: [],
    ...
    // â”€â”€â”€ TotalInvested â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    public void CalculateTotalInvested_MirrorPortfolio_IncludesMirrorPositionsAndAdjustedAvailability()
    {
        ...
        // mirrorPositions=200, adjustedAvailability=100-50=50 â†’ total=250
        var result = _service.CalculateTotalInvested(pnl);
    ...
    public void CalculateTotalInvested_ComplexScenario_CorrectSum()
    {
        ...
        // manual pending=200+10=210, MIT=150 â†’ total=1560
        var pnl = new PnlResponse(
            0m,
    ...
    // â”€â”€â”€ ProfitLoss â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    // â”€â”€â”€ Equity â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€

    [Test]
    public void CalculateEquity_SimpleCase_EqualsSumOfComponents()
    {
        // credit=1000, no orders â†’ availableCash=1000
        // positions=500 â†’ totalInvested=500
        // pnl=50 â†’ pnl=50
        // equity = 1550
        var pnl = new PnlResponse(
            1000m,
    ...
    // â”€â”€â”€ RealizedProfit â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    {
        // 2 full pages + 1 empty page â†’ exits cleanly at empty page, no throw
        var handler = new MetricsHttpMessageHandler([
            [CreateTrade(positionId: 1, netProfit: 1m)],
            [CreateTrade(positionId: 2, netProfit: 1m)],
            []
    ...
    public async Task GetAccountMetricsAsync_DeduplicatesPositionIds_CountsOnce()
    {
        ...
        var handler = new MetricsHttpMessageHandler([
            ...
            // page 2 returns empty (out of range) â†’ terminates naturally
        ]);
        var client = new EToroClient(new HttpClient(handler)
        {
            BaseAddress = new Uri("https://public-api.etoro.com/api/v1/")
    ...
    {
        // Page 0: trade 1. Page 1: trade 1 again (all duplicates) â†’ stop.
        var handler = new MetricsHttpMessageHandler([
